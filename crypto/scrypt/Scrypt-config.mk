...
target_c_includes := $(addprefix bootable/recovery-twrp/crypto/scrypt/,$(common_c_includes)) $(local_c_includes)
...
host_c_includes := $(addprefix bootable/recovery-twrp/crypto/scrypt/,$(common_c_includes)) $(local_c_includes)
